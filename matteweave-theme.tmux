...
set "status-left" "#{?client_prefix,$(l_cheek $prefix_active $raisin)#[fg=$raisin bg=$prefix_active bold]${status_left}$(r_cheek $prefix_active $raisin)#[bg=default] ,$(l_cheek $green_bright $raisin)#[fg=$raisin bg=$green_bright bold]${status_left}$(r_cheek $green_bright $raisin)#[bg=default] }"
...
set "status-right" "${widgets}$(l_cheek $green_bright $raisin)#[fg=$raisin bg=$green_bright] #{d-1:pane_current_path}/#{b:pane_current_path} $(r_cheek $green_bright $raisin)"
